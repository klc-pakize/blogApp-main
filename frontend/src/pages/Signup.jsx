                ...
                <div className="card-body p-5 text-center">
                  <div className="mb-md-5 mt-md-4 pb-5">
                    ...
                    <div className="form-outline form-white mb-4">
                      ...
                      />
                      <label className="form-label" htmlFor="typePasswordX1">
                        Password
                      </label>
                    </div>
                    <div className="form-outline form-white mb-4">
                      <input
                        ...
                        className="form-control form-control-lg border"
                      />
                      <label className="form-label" htmlFor="typePasswordX2">
                        Password2
                      </label>
                    </div>
                    <div className="form-outline form-white mb-4">
                      <input
                        ...
                        className="form-control form-control-lg border mb-4"
                      />
                      <label className="form-label " htmlFor="typeImageX">
                        Image
                      </label>
                    </div>
                    <div className="form-outline form-white mb-4">
                      <textarea
                        ...
                        className="form-control form-control-lg border mb-4"
                      ></textarea>
                      <label className="form-label " htmlFor="typeBioX">
                        Bio
                      </label>
                    </div>
